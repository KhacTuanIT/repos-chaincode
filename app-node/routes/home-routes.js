...
const { about, account, cart, contact, home, payment, product, getProduct, getAllProduct, register, registerClientView, loginClient, loginClientView } = require('../controllers/client/index');
const { enrollAdmin, addProduct, addUser } = require('../controllers/admin/enrollController');
const { getProductAPI, getAllProductAPI } = require('../controllers/api/productController');
